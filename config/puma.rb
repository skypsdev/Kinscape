...
#   # https://github.com/mperham/sidekiq/issues/627#issuecomment-20366059
#
...
#           f.close
#
#           s_3 = Aws::S3::Client.new(region: 'us-east-1')
#           File.open(f, 'rb') do |file|
#             s_3.put_object(
#               body: file,
#               key: "#{Time.now.iso8601}-process:#{Process.pid}-heap.dump",
#               bucket: 'heap-dumps-schneems'
#             )
#           end
#         end
#       end
