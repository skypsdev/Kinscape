          ...
          <v-row>
            ...
            <v-col class="mt-16">
              <p class="profile-setup__description">
                {{ $i18n.t('welcome.profile_description') }}
              </p>
              ...
              <v-row>
                <v-col cols="12" md="5">
                  <v-text-field
                      ...
                      :placeholder="$i18n.t('welcome.email_placeholder')"
                      v-model="profile.profileAttrs.emails[0].value"
                      outlined
                      single-line
                      color="primary"
                      type="text"
                  ...
                  <v-text-field
                      ...
                      :placeholder="$i18n.t('welcome.birth_place_placeholder')"
                ...
                <v-col cols="12" md="5" offset-md="1">
                  <v-text-field
                      ...
                      :placeholder="$i18n.t('welcome.location_placeholder')"
                      v-model="profile.profileAttrs.locations[0].value"
                      outlined
                      single-line
                      color="primary"
                      type="text"
                  ...
                  <v-text-field
                      ...
                      :placeholder="$i18n.t('welcome.address_placeholder')"
                      v-model="profile.profileAttrs.addresses[0].value"
                      outlined
                      single-line
                      color="primary"
                      type="text"
