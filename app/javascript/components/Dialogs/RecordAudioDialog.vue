      ...
      <div class="pt-15 pb-5 px-0">
        <v-row v-if="!isDeviceReady">
          <v-col class="d-flex justify-center">
            <p class="record-audio__call-to-action">
        ...
        <v-row v-if="isDeviceReady && !isRecordingFinished">
          <v-col class="d-flex flex-row align-center justify-center">
            <div class="record-audio__controls-container d-flex flex-row justify-start align-center mr-5">
              <v-btn
                  class="ml-3"
                  color="primary"
                  fab
              ...
              <span class="record-audio__timestamp ml-2">
                {{ timestamp }}
              </span>
            </div>
            <v-btn
              fab
              :color="isRecording ? '#A293FE' : 'primary'"
...
.record-audio {
  ...
  &__controls-container {
    ...
    left: 598px;
    top: 673px;
    background: rgba(162, 147, 254, 0.2);
    border-radius: 60px;
  }
  &__stop-button {}
  &__play-button {}
