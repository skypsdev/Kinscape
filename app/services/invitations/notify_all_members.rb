module Invitations
  class NotifyAllMembers < ApplicationService
    ...
    def call
      ::MailerService.call(
        ...
        params: {
          ...
          family: family,
          recipients_name: members_names
        }
      )
      ::MailerService.call(:welcome_to_family, params: { user: recipient, family: family }) if recipient
    end
